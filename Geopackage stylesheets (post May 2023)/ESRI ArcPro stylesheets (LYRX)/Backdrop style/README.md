...
**8.**  Your Table of Contents should now look like this. This is the recommended layer order:
  ...
  ![Screenshot] (https://github.com/OrdnanceSurvey/OS-VectorMap-District-stylesheets/blob/3c649087268fdff151d3e6ced0422be042813e0d/Geopackage%20stylesheets%20(post%20May%202023)/ESRI%20ArcPro%20stylesheets%20(LYRX)/Backdrop%20style/images/VMD_layerorder.PNG "Recommended layer order for OS VectorMap District")
