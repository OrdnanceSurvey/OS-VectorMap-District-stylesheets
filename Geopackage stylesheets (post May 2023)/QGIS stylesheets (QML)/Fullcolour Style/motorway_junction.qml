...
<qgis maxScale="10000" simplifyAlgorithm="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyDrawingTol="1" symbologyReferenceScale="-1" labelsEnabled="1" simplifyDrawingHints="0" styleCategories="AllStyleCategories" readOnly="0" version="3.22.4-Białowieża" minScale="25001" simplifyLocal="1">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style previewBkgrdColor="255,255,255,255" allowHtml="0" fontKerning="1" blendMode="0" fontWeight="75" capitalization="0" fontSizeUnit="MapUnit" fontItalic="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textOpacity="1" isExpression="0" fontLetterSpacing="0" textOrientation="horizontal" fontUnderline="0" fontStrikeout="0" fontSize="50" multilineHeight="1" legendString="Aa" namedStyle="Bold" fontFamily="Arial" textColor="255,255,255,255" fontWordSpacing="0" fieldName="junction_number" useSubstitutions="0">
        <families/>
        ...
        <background shapeBorderWidthUnit="MM" shapeSizeY="3" shapeSVGFile="" shapeSizeX="15" shapeOffsetUnit="MM" shapeBorderColor="0,159,184,199" shapeRotationType="0" shapeOffsetX="0" shapeType="0" shapeSizeType="0" shapeDraw="1" shapeRadiiUnit="MM" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeBlendMode="0" shapeRotation="0" shapeOffsetY="0" shapeBorderWidth="0.2646" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiX="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSizeUnit="MapUnit" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiY="0" shapeFillColor="0,159,184,255" shapeJoinStyle="64" shapeOpacity="1">
          ...
          <symbol alpha="1" clip_to_extent="1" name="fillSymbol" force_rhr="0" type="fill">
            ...
            <layer enabled="1" locked="0" pass="0" class="SimpleFill">
              <Option type="Map">
                ...
                <Option name="color" type="QString" value="0,159,184,255"/>
                <Option name="joinstyle" type="QString" value="round"/>
                <Option name="offset" type="QString" value="0,0"/>
                <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
                <Option name="offset_unit" type="QString" value="MM"/>
                <Option name="outline_color" type="QString" value="0,159,184,199"/>
                <Option name="outline_style" type="QString" value="solid"/>
              ...
              <prop v="0,159,184,255" k="color"/>
              <prop v="round" k="joinstyle"/>
              <prop v="0,0" k="offset"/>
              <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
              <prop v="MM" k="offset_unit"/>
              <prop v="0,159,184,199" k="outline_color"/>
              <prop v="solid" k="outline_style"/>
      ...
      <placement offsetType="0" geometryGeneratorEnabled="0" fitInPolygonOnly="0" overrunDistanceUnit="MM" priority="10" centroidInside="0" maxCurvedCharAngleIn="20" rotationUnit="AngleDegrees" centroidWhole="0" repeatDistanceUnits="MM" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" layerType="PointGeometry" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" yOffset="0" overrunDistance="0" distUnits="MapUnit" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" polygonPlacementFlags="2" maxCurvedCharAngleOut="-20" lineAnchorType="0" quadOffset="4" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" offsetUnits="MapUnit" placement="0" geometryGenerator="" repeatDistance="0" lineAnchorClipping="0" distMapUnitScale="3x:0,0,0,0,0,0" lineAnchorPercent="0.5" placementFlags="0" xOffset="0" dist="180" rotationAngle="0" preserveRotation="1" geometryGeneratorType="PointGeometry"/>
  ...
  <fieldConfiguration>
    ...
    <field name="junction_number" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias name="" index="2" field="feature_code"/>
    <alias name="" index="3" field="junction_number"/>
  </aliases>
  <defaults>
    <default expression="" applyOnUpdate="0" field="fid"/>
    <default expression="" applyOnUpdate="0" field="id"/>
    <default expression="" applyOnUpdate="0" field="feature_code"/>
    <default expression="" applyOnUpdate="0" field="junction_number"/>
  </defaults>
  <constraints>
    ...
    <constraint constraints="0" unique_strength="0" exp_strength="0" field="junction_number" notnull_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint exp="" desc="" field="fid"/>
    <constraint exp="" desc="" field="id"/>
    <constraint exp="" desc="" field="feature_code"/>
    <constraint exp="" desc="" field="junction_number"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column name="junction_number" width="-1" type="field" hidden="0"/>
    </columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="junctionNumber" editable="1"/>
    <field name="junction_number" editable="1"/>
  </editable>
  <labelOnTop>
    ...
    <field name="junctionNumber" labelOnTop="0"/>
    <field name="junction_number" labelOnTop="0"/>
  </labelOnTop>
  <reuseLastValue>
    <field reuseLastValue="0" name="feature_code"/>
    <field reuseLastValue="0" name="fid"/>
    <field reuseLastValue="0" name="id"/>
    <field reuseLastValue="0" name="junction_number"/>
  </reuseLastValue>
