...
<qgis maxScale="10000" simplifyAlgorithm="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyDrawingTol="1" symbologyReferenceScale="-1" labelsEnabled="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" readOnly="0" version="3.22.4-Białowieża" minScale="25001" simplifyLocal="1">
      ...
      <symbol alpha="1" clip_to_extent="1" name="0" force_rhr="0" type="fill">
        ...
        <layer enabled="1" locked="0" pass="0" class="SimpleFill">
          <Option type="Map">
            ...
            <Option name="color" type="QString" value="232,247,232,255"/>
          ...
          <prop v="232,247,232,255" k="color"/>
        ...
        <layer enabled="1" locked="0" pass="0" class="SimpleFill">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="color" type="QString" value="121,159,121,255"/>
            <Option name="joinstyle" type="QString" value="bevel"/>
            <Option name="offset" type="QString" value="0,0"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MapUnit"/>
            <Option name="outline_color" type="QString" value="121,159,121,255"/>
          ...
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="121,159,121,255" k="color"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MapUnit" k="offset_unit"/>
          <prop v="121,159,121,255" k="outline_color"/>
  ...
  <DiagramLayerSettings priority="0" linePlacementFlags="18" placement="1" zIndex="0" showAll="1" obstacle="0" dist="0">
    <properties>
      <Option type="Map">
        <Option name="name" type="QString" value=""/>
        <Option name="properties"/>
