...
<qgis maxScale="10000" simplifyAlgorithm="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyDrawingTol="1" symbologyReferenceScale="-1" labelsEnabled="1" simplifyDrawingHints="0" styleCategories="AllStyleCategories" readOnly="0" version="3.22.4-Białowieża" minScale="25001" simplifyLocal="1">
  <flags>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style previewBkgrdColor="255,255,255,255" allowHtml="0" fontKerning="1" blendMode="0" fontWeight="50" capitalization="0" fontSizeUnit="MapUnit" fontItalic="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textOpacity="1" isExpression="1" fontLetterSpacing="0" textOrientation="horizontal" fontUnderline="0" fontStrikeout="0" fontSize="44.100000000000001" multilineHeight="1" legendString="Aa" namedStyle="Regular" fontFamily="Arial" textColor="113,113,113,255" fontWordSpacing="0" fieldName="CASE WHEN length( &quot;distinctive_name&quot; ) > 13 AND strpos(&quot;distinctive_name&quot;,' ') > 6 THEN replace(&quot;distinctive_name&quot;,' ','  ') WHEN length( &quot;distinctive_name&quot; ) > 20 AND &quot;distinctive_name&quot; LIKE '%Golf Course' THEN regexp_replace(&quot;distinctive_name&quot;,'Golf Course',' Golf Course') WHEN length( &quot;distinctive_name&quot; ) > 20 AND &quot;distinctive_name&quot; LIKE '%Nature Reserve' THEN regexp_replace(&quot;distinctive_name&quot;,'Nature Reserve',' Nature Reserve') WHEN length( &quot;distinctive_name&quot; ) > 20 AND &quot;distinctive_name&quot; LIKE '%Church Of England%' THEN regexp_replace(&quot;distinctive_name&quot;,'Church Of England',' Church Of England ') WHEN length( &quot;distinctive_name&quot; ) > 13 AND &quot;distinctive_name&quot; LIKE '% Of The %' THEN regexp_replace(&quot;distinctive_name&quot;,'Of The','Of The ') WHEN length( &quot;distinctive_name&quot; ) > 13 AND &quot;distinctive_name&quot; LIKE '% of %' AND &quot;classification&quot; &lt;> 'Hydrography' THEN regexp_replace(&quot;distinctive_name&quot;,' of ',' of ') WHEN &quot;distinctive_name&quot; LIKE '%/%' THEN regexp_replace(&quot;distinctive_name&quot;,'/','/ ') WHEN length( &quot;distinctive_name&quot; ) > 30 THEN replace(&quot;distinctive_name&quot;,' ','  ') ELSE &quot;distinctive_name&quot; END" useSubstitutions="0">
        <families/>
        <text-buffer bufferSizeUnits="MM" bufferJoinStyle="128" bufferSize="1" bufferOpacity="0.84999999999999998" bufferBlendMode="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="250,249,247,255" bufferNoFill="0" bufferDraw="1"/>
      ...
      <placement offsetType="0" geometryGeneratorEnabled="0" fitInPolygonOnly="0" overrunDistanceUnit="MM" priority="6" centroidInside="0" maxCurvedCharAngleIn="20" rotationUnit="AngleDegrees" centroidWhole="0" repeatDistanceUnits="MM" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" layerType="PointGeometry" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" yOffset="0" overrunDistance="0" distUnits="MM" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" polygonPlacementFlags="2" maxCurvedCharAngleOut="-20" lineAnchorType="0" quadOffset="4" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" offsetUnits="MM" placement="1" geometryGenerator="" repeatDistance="0" lineAnchorClipping="0" distMapUnitScale="3x:0,0,0,0,0,0" lineAnchorPercent="0.5" placementFlags="0" xOffset="0" dist="0" rotationAngle="0" preserveRotation="1" geometryGeneratorType="PointGeometry"/>
      <rendering scaleMin="1" drawLabels="1" fontMaxPixelSize="10000" obstacle="1" displayAll="0" upsidedownLabels="0" obstacleFactor="1" minFeatureSize="0" scaleMax="10000000" zIndex="0" fontLimitPixelSize="0" limitNumLabels="0" labelPerPart="0" unplacedVisibility="0" maxNumLabels="2000" obstacleType="0" mergeLines="0" fontMinPixelSize="3" scaleVisibility="0"/>
      <dd_properties>
        <Option type="Map">
          <Option name="name" type="QString" value=""/>
          <Option name="properties" type="Map">
            <Option name="Color" type="Map">
              ...
              <Option name="expression" type="QString" value="CASE WHEN &quot;classification&quot; = 'Woodland Or Forest' THEN color_rgb(121,165,114) WHEN &quot;classification&quot; = 'Hydrography' THEN color_rgb(37,173,201) ELSE color_rgb(113,113,113) END"/>
              <Option name="type" type="int" value="3"/>
            </Option>
            <Option name="FontLetterSpacing" type="Map">
              <Option name="active" type="bool" value="true"/>
              <Option name="expression" type="QString" value="CASE WHEN (&quot;classification&quot; = 'Populated Place') AND &quot;font_height&quot; = 'Large' THEN 12.7 WHEN &quot;classification&quot; = 'Populated Place' AND &quot;font_height&quot; = 'Extra Large' THEN 18.52 WHEN &quot;classification&quot; = 'Landcover' AND &quot;font_height&quot; = 'Extra Large' THEN 25.4 WHEN &quot;classification&quot; = 'Hydrography' AND &quot;font_height&quot; = 'Small' THEN 5.64 WHEN &quot;classification&quot; = 'Hydrography' AND &quot;font_height&quot; = 'Large' THEN 31.05 WHEN &quot;classification&quot; = 'Hydrography' AND &quot;font_height&quot; = 'Extra Large' THEN 90.31 ELSE 0 END"/>
              <Option name="type" type="int" value="3"/>
            </Option>
            <Option name="Size" type="Map">
              <Option name="active" type="bool" value="true"/>
              <Option name="expression" type="QString" value="CASE WHEN (&quot;classification&quot; = 'Populated Place' OR &quot;classification&quot; = 'Hydrography') AND &quot;font_height&quot; = 'Medium' THEN 67.74 WHEN (&quot;classification&quot; &lt;> 'Populated Place' AND &quot;classification&quot; &lt;> 'Hydrography') AND &quot;font_height&quot; = 'Medium' THEN 52.92 WHEN (&quot;classification&quot; = 'Landcover' OR &quot;classification&quot; = 'Landform' OR &quot;classification&quot; = 'Woodland Or Forest') AND &quot;font_height&quot; = 'Large' THEN 79.38 WHEN &quot;classification&quot; = 'Populated Place' AND &quot;font_height&quot; = 'Large' THEN 105.83 WHEN &quot;classification&quot; = 'Hydrography' AND &quot;font_height&quot; = 'Large' THEN 97.01 WHEN (&quot;classification&quot; = 'Landform' OR  &quot;classification&quot; = 'Hydrography') AND &quot;font_height&quot; = 'Extra Large' THEN 141.11 WHEN (&quot;classification&quot; = 'Landcover' OR &quot;classification&quot; = 'Woodland Or Forest') AND &quot;font_height&quot; = 'Extra Large' THEN 158.75 WHEN &quot;classification&quot; = 'Populated Place' AND &quot;font_height&quot; = 'Extra Large' THEN 132.29 ELSE 44.1 END"/>
              <Option name="type" type="int" value="3"/>
            </Option>
          </Option>
          <Option name="type" type="QString" value="collection"/>
  ...
  <DiagramLayerSettings priority="0" linePlacementFlags="18" placement="0" zIndex="0" showAll="1" obstacle="0" dist="0">
    <properties>
      <Option type="Map">
        <Option name="name" type="QString" value=""/>
        <Option name="properties"/>
  ...
  <fieldConfiguration>
    ...
    <field name="font_height" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="text_orientation" configurationFlags="None">
      <editWidget type="Range">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias name="" index="5" field="font_height"/>
    <alias name="" index="6" field="text_orientation"/>
  </aliases>
  <defaults>
    ...
    <default expression="" applyOnUpdate="0" field="font_height"/>
    <default expression="" applyOnUpdate="0" field="text_orientation"/>
  </defaults>
  <constraints>
    ...
    <constraint constraints="0" unique_strength="0" exp_strength="0" field="font_height" notnull_strength="0"/>
    <constraint constraints="0" unique_strength="0" exp_strength="0" field="text_orientation" notnull_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="font_height"/>
    <constraint exp="" desc="" field="text_orientation"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column name="font_height" width="-1" type="field" hidden="0"/>
      <column name="text_orientation" width="-1" type="field" hidden="0"/>
    </columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="font_height" editable="1"/>
    <field name="gml_id" editable="1"/>
    <field name="id" editable="1"/>
    <field name="textOrientation" editable="1"/>
    <field name="textOrientation_uom" editable="1"/>
    <field name="text_orientation" editable="1"/>
  </editable>
  <labelOnTop>
    ...
    <field name="font_height" labelOnTop="0"/>
    <field name="gml_id" labelOnTop="0"/>
    <field name="id" labelOnTop="0"/>
    <field name="textOrientation" labelOnTop="0"/>
    <field name="textOrientation_uom" labelOnTop="0"/>
    <field name="text_orientation" labelOnTop="0"/>
  </labelOnTop>
  <reuseLastValue>
    ...
    <field reuseLastValue="0" name="font_height"/>
    <field reuseLastValue="0" name="id"/>
    <field reuseLastValue="0" name="text_orientation"/>
  </reuseLastValue>
