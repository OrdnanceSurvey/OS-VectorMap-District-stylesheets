...
<qgis version="2.2.0-Valmiera" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
    ...
    <symbols>
      <symbol alpha="1" type="marker" name="0">
        <layer pass="0" class="SimpleMarker" locked="0">
          ...
          <prop k="color_border" v="255,255,255,200"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="regular_star"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          <prop k="outline_style" v="solid"/>
          <prop k="outline_width" v="14"/>
        ...
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="222,98,102,0"/>
          <prop k="color_border" v="222,98,102,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="regular_star"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="CASE WHEN  length( &quot;name&quot; ) > 19 AND strpos(&quot;name&quot;,' ') > 9  THEN  replace(&quot;name&quot;,' ','  ') WHEN  length( &quot;name&quot; ) > 13 AND &quot;name&quot;  LIKE '%(%' THEN  regexp_replace(&quot;name&quot;, '[]([]', ' (')  ELSE  &quot;name&quot;  END"/>
    ...
    <property key="labeling/fontSize" value="64"/>
    ...
    <property key="labeling/textColorR" value="222"/>
    <property key="labeling/textTransp" value="0"/>
    <property key="labeling/upsidedownLabels" value="0"/>
    <property key="labeling/wrapChar" value="  "/>
    <property key="labeling/xOffset" value="60"/>
