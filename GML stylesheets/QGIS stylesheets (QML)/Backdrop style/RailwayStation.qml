...
<qgis hasScaleBasedVisibilityFlag="1" minScale="25001" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyLocal="1" version="3.16.7-Hannover" readOnly="0" styleCategories="AllStyleCategories" maxScale="10000" simplifyMaxScale="1" simplifyAlgorithm="0" labelsEnabled="1">
  ...
  <renderer-v2 attr="featureCode" enableorderby="0" forceraster="0" type="categorizedSymbol" symbollevels="0">
    <categories>
      <category symbol="0" value="25420" render="true" label="Light Rapid Transit Station"/>
      <category symbol="1" value="25422" render="true" label="Railway Station"/>
      <category symbol="2" value="25423" render="true" label="London Underground Station"/>
      <category symbol="3" value="25424" render="true" label="Railway Station And London Underground Station"/>
      <category symbol="4" value="25425" render="true" label="Light Rapid Transit Station And Railway Station"/>
      <category symbol="5" value="25426" render="true" label="Light Rapid Transit Station And London Underground Station"/>
    </categories>
    <symbols>
      <symbol clip_to_extent="1" type="marker" force_rhr="0" name="0" alpha="1">
        <layer enabled="1" pass="0" locked="0" class="SvgMarker">
          ...
          <prop k="name" v="ordnance_survey/LRT-bd.svg"/>
          <prop k="offset" v="0,0"/>
      ...
      <symbol clip_to_extent="1" type="marker" force_rhr="0" name="1" alpha="1">
        <layer enabled="1" pass="0" locked="0" class="SvgMarker">
          ...
          <prop k="fixedAspectRatio" v="0"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="ordnance_survey/OG-bd.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          <prop k="outline_color" v="100,100,100,255"/>
      ...
      <symbol clip_to_extent="1" type="marker" force_rhr="0" name="2" alpha="1">
        <layer enabled="1" pass="0" locked="0" class="SvgMarker">
          ...
          <prop k="fixedAspectRatio" v="0"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="ordnance_survey/UG-bd.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
      ...
      <symbol clip_to_extent="1" type="marker" force_rhr="0" name="3" alpha="1">
        <layer enabled="1" pass="0" locked="0" class="SvgMarker">
          ...
          <prop k="fixedAspectRatio" v="0"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="ordnance_survey/OG_UG-bd.svg"/>
      ...
      <symbol clip_to_extent="1" type="marker" force_rhr="0" name="4" alpha="1">
        <layer enabled="1" pass="0" locked="0" class="SvgMarker">
          ...
          <prop k="fixedAspectRatio" v="0"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="ordnance_survey/OG_LRT-bd.svg"/>
      ...
      <symbol clip_to_extent="1" type="marker" force_rhr="0" name="5" alpha="1">
        <layer enabled="1" pass="0" locked="0" class="SvgMarker">
          ...
          <prop k="fixedAspectRatio" v="0"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="ordnance_survey/LRT_UG-bd.svg"/>
          <prop k="offset" v="-27,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          <prop k="outline_color" v="100,100,100,255"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style previewBkgrdColor="255,255,255,255" blendMode="0" textColor="115,113,113,255" fontWordSpacing="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontFamily="Arial" fontKerning="1" capitalization="0" fontSizeUnit="MapUnit" fontItalic="0" fontUnderline="0" fontWeight="75" fontSize="50" isExpression="1" namedStyle="Bold" textOrientation="horizontal" textOpacity="1" fontStrikeout="0" useSubstitutions="0" multilineHeight="1" allowHtml="0" fieldName="wordwrap(&quot;distinctiveName&quot;, 20)" fontLetterSpacing="0">
        <text-buffer bufferBlendMode="0" bufferOpacity="0.75" bufferJoinStyle="128" bufferSizeUnits="MM" bufferSize="1" bufferNoFill="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="255,255,255,255" bufferDraw="1"/>
      ...
      <placement priority="8" geometryGeneratorEnabled="0" centroidWhole="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" quadOffset="5" lineAnchorPercent="0.5" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" offsetType="0" polygonPlacementFlags="2" offsetUnits="MapUnit" placement="1" maxCurvedCharAngleOut="-20" repeatDistance="0" layerType="PointGeometry" xOffset="35" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" distUnits="MM" distMapUnitScale="3x:0,0,0,0,0,0" placementFlags="0" fitInPolygonOnly="0" overrunDistance="0" overrunDistanceUnit="MM" geometryGenerator="" geometryGeneratorType="PointGeometry" yOffset="0" lineAnchorType="0" rotationAngle="0" preserveRotation="1" maxCurvedCharAngleIn="20" repeatDistanceUnits="MM" dist="0"/>
        ...
        <Option type="Map">
          ...
          <Option type="Map" name="properties">
            <Option type="Map" name="OffsetXY">
              ...
              <Option type="QString" value="CASE WHEN &quot;featureCode&quot; = 25422 OR &quot;featureCode&quot; = 25420 THEN '45,0' WHEN &quot;featureCode&quot; = 25426 OR &quot;featureCode&quot; = 25424 THEN '85,0' WHEN &quot;featureCode&quot; = 25423 THEN '45,0' WHEN &quot;featureCode&quot; = 25425 THEN '60,0' END" name="expression"/>
  ...
  <aliases>
    ...
    <alias field="featureCode" name="" index="4"/>
  </aliases>
  <defaults>
