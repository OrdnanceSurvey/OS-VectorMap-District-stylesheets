...
<qgis version="2.8.1-Wien" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="featureCode" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="25704" label="A Road"/>
      <category render="true" symbol="1" value="25705" label="B Road"/>
      <category render="true" symbol="2" value="25706" label="Minor Road"/>
      <category render="true" symbol="3" value="25707" label="Local Street"/>
      <category render="true" symbol="4" value="25703" label="Primary Road"/>
    </categories>
    <symbols>
    ...
    <source-symbol>
      <symbol alpha="1" type="marker" name="0">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="212,127,212,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="circle"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
