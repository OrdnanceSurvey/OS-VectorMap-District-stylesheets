...
<qgis version="2.18.14" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="featureCode" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      ...
      <category render="true" symbol="2" value="15120" label="Antiquity site"/>
      <category render="true" symbol="3" value="15211" label="Boundary Point"/>
      ...
      <category render="true" symbol="8" value="15610" label="Standard flow arrow"/>
      <category render="true" symbol="9" value="15611" label="Large flow arrow"/>
    </categories>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="marker" name="0">
        <layer pass="0" class="FontMarker" locked="0">
          ...
          <prop k="angle_dd_expression" v="360 - orientation / 10 + 270"/>
          <prop k="angle_dd_field" v=""/>
          <prop k="angle_dd_useexpr" v="1"/>
          <prop k="chr" v="E"/>
          <prop k="color" v="178,184,173,255"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="marker" name="8">
        <layer pass="0" class="FontMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="angle_dd_active" v="1"/>
          <prop k="angle_dd_expression" v="&quot;orientation&quot;  / 10"/>
          <prop k="angle_dd_field" v=""/>
          <prop k="angle_dd_useexpr" v="1"/>
          <prop k="chr" v="D"/>
          <prop k="color" v="0,154,207,255"/>
  ...
  <aliases>
    ...
    <alias field="orientation" index="3" name=""/>
    <alias field="orientation_uom" index="4" name=""/>
