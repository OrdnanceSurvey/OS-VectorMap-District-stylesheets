...
<qgis minScale="1e+08" simplifyDrawingHints="1" maxScale="0" simplifyMaxScale="1" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" version="3.4.1-Madeira" styleCategories="AllStyleCategories" simplifyAlgorithm="0" labelsEnabled="1" simplifyDrawingTol="1">
  <flags>
    <Identifiable>1</Identifiable>
    <Removable>1</Removable>
    <Searchable>1</Searchable>
  </flags>
  <renderer-v2 enableorderby="0" type="categorizedSymbol" attr="featureCode" forceraster="0" symbollevels="1">
    <categories>
      <category symbol="0" label="Motorway" render="true" value="25710"/>
      <category symbol="1" label="Motorway, Collapsed Dual Carriageway" render="true" value="25719"/>
      <category symbol="2" label="Primary Road" render="true" value="25723"/>
      <category symbol="3" label="A Road" render="true" value="25729"/>
      <category symbol="4" label="Primary Road, Collapsed Dual Carriageway" render="true" value="25735"/>
      <category symbol="5" label="A Road, Collapsed Dual Carriageway" render="true" value="25739"/>
      <category symbol="6" label="B Road" render="true" value="25743"/>
      <category symbol="7" label="B Road, Collapsed Dual Carriageway" render="true" value="25749"/>
      <category symbol="8" label="Minor Road" render="true" value="25750"/>
      <category symbol="9" label="Minor Road, Collapsed Dual Carriageway" render="true" value="25759"/>
      <category symbol="10" label="Local Street" render="true" value="25760"/>
      <category symbol="11" label="Private Road Publicly Accessible" render="true" value="25780"/>
      <category symbol="12" label="Pedestrianised Street" render="true" value="25790"/>
    </categories>
    <symbols>
      ...
      <symbol alpha="1" type="line" clip_to_extent="1" name="11">
      ...
      <symbol alpha="1" type="line" clip_to_extent="1" name="12">
      ...
      <symbol alpha="1" type="line" clip_to_extent="1" name="2">
        <layer enabled="1" pass="9" class="SimpleLine" locked="0">
          <prop v="round" k="capstyle"/>
          <prop v="5;2" k="customdash"/>
          <prop v="3x:0,0,0,0,0,0" k="customdash_map_unit_scale"/>
          <prop v="MapUnit" k="customdash_unit"/>
      ...
      <symbol alpha="1" type="line" clip_to_extent="1" name="4">
        <layer enabled="1" pass="10" class="SimpleLine" locked="0">
          <prop v="flat" k="capstyle"/>
          <prop v="5;2" k="customdash"/>
          <prop v="3x:0,0,0,0,0,0" k="customdash_map_unit_scale"/>
          <prop v="MapUnit" k="customdash_unit"/>
  ...
  <labeling type="simple">
    <settings>
      <text-style useSubstitutions="0" fontLetterSpacing="0" textColor="255,255,255,255" multilineHeight="1" fontWordSpacing="0" fontWeight="75" isExpression="1" fontItalic="0" blendMode="0" textOpacity="1" fontFamily="Arial" namedStyle="Bold" fontUnderline="0" fontSizeUnit="MapUnit" fontCapitals="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" previewBkgrdColor="#ffffff" fontSize="45.83" fieldName="CASE WHEN  &quot;featureCode&quot; = 25729 OR &quot;featureCode&quot; = 25739 THEN  regexp_replace( &quot;roadNumber&quot;, 'A',' A') ELSE  &quot;roadNumber&quot; END" fontStrikeout="0">
        <text-buffer bufferBlendMode="0" bufferSize="1" bufferDraw="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferOpacity="1" bufferNoFill="0" bufferJoinStyle="64" bufferSizeUnits="MM" bufferColor="255,255,255,255"/>
        <background shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSizeUnit="MapUnit" shapeJoinStyle="128" shapeDraw="1" shapeRadiiY="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeSVGFile="" shapeRadiiX="0" shapeOffsetX="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeRotation="0" shapeRotationType="0" shapeOpacity="1" shapeBorderWidthUnit="MM" shapeOffsetUnit="MapUnit" shapeRadiiUnit="MapUnit" shapeSizeY="3" shapeFillColor="235,148,177,255" shapeBlendMode="0" shapeBorderWidth="0.2646" shapeBorderColor="253,253,252,199" shapeSizeX="15" shapeSizeType="0" shapeType="0" shapeOffsetY="0"/>
      ...
      <placement predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" priority="5" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" rotationAngle="0" quadOffset="4" maxCurvedCharAngleIn="20" maxCurvedCharAngleOut="-20" xOffset="0" distMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" placement="4" repeatDistanceUnits="MM" offsetUnits="MapUnit" yOffset="0" centroidInside="0" preserveRotation="0" dist="0" fitInPolygonOnly="0" placementFlags="0" distUnits="MM" repeatDistance="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetType="0"/>
        ...
        <Option type="Map">
          ...
          <Option type="Map" name="properties">
            <Option type="Map" name="ShapeFillColor">
              ...
              <Option type="QString" value="CASE WHEN  &quot;CLASSIFICA&quot; LIKE 'A%' THEN  color_rgb(235,148,177) WHEN  &quot;CLASSIFICA&quot; LIKE 'B%' THEN  color_rgb(237,186,145) WHEN  &quot;CLASSIFICA&quot; LIKE 'P%' THEN  color_rgb(136,191,143) WHEN  &quot;CLASSIFICA&quot; LIKE 'M%' THEN  color_rgb(54,177,201) END" name="expression"/>
              <Option type="int" value="3" name="type"/>
            </Option>
            <Option type="Map" name="ShapeOffset">
              <Option type="bool" value="true" name="active"/>
              <Option type="QString" value="CASE WHEN &quot;FEATCODE&quot; = 25729 OR &quot;FEATCODE&quot; = 25739 THEN '3,0' ELSE '0,0' END" name="expression"/>
              <Option type="int" value="3" name="type"/>
            </Option>
            <Option type="Map" name="ShapeSizeX">
              <Option type="bool" value="true" name="active"/>
              <Option type="QString" value="CASE WHEN &quot;FEATCODE&quot; = 25729 OR &quot;FEATCODE&quot; = 25739 THEN 11 ELSE 15 END" name="expression"/>
              <Option type="int" value="3" name="type"/>
            </Option>
          </Option>
          <Option type="QString" value="collection" name="type"/>
