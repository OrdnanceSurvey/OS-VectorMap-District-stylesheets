...
<qgis minScale="1e+08" simplifyDrawingHints="1" maxScale="0" simplifyMaxScale="1" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" version="3.4.1-Madeira" styleCategories="AllStyleCategories" simplifyAlgorithm="0" labelsEnabled="0" simplifyDrawingTol="1">
  ...
  <renderer-v2 enableorderby="0" type="categorizedSymbol" attr="featureCode" forceraster="0" symbollevels="0">
    <categories>
      <category symbol="0" label="Multi Track" render="true" value="25300"/>
      <category symbol="1" label="Single Track" render="true" value="25301"/>
      <category symbol="2" label="Narrow Gauge" render="true" value="25302"/>
    </categories>
    <symbols>
