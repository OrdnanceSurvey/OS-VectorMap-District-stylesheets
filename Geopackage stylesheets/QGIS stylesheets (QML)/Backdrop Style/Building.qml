...
<qgis hasScaleBasedVisibilityFlag="1" minScale="25001" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyLocal="1" version="3.16.7-Hannover" readOnly="0" styleCategories="AllStyleCategories" maxScale="10000" simplifyMaxScale="1" simplifyAlgorithm="0" labelsEnabled="0">
  ...
  <renderer-v2 enableorderby="0" forceraster="0" type="RuleRenderer" symbollevels="0">
    <rules key="{6940fe15-e206-4af3-8c2a-4ea21bfd51b1}">
      <rule symbol="0" scalemindenom="9999" scalemaxdenom="17500" label="1:10,000 to 1:17,500" key="{fd5ba4c6-18b0-4688-b01e-39a008c3dfe4}"/>
      <rule symbol="1" scalemindenom="17500" scalemaxdenom="25001" label="1:17,500 to 1:25,000" key="{987814b1-1adf-40a2-9148-b9be0b168e7c}"/>
    </rules>
    <symbols>
      ...
      <symbol clip_to_extent="1" type="fill" force_rhr="0" name="1" alpha="1">
        <layer enabled="1" pass="0" locked="0" class="SimpleFill">
          ...
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          <prop k="outline_color" v="150,150,150,0"/>
          <prop k="outline_style" v="solid"/>
          <prop k="outline_width" v="2.5"/>
          <prop k="outline_width_unit" v="MapUnit"/>
          <prop k="style" v="solid"/>
