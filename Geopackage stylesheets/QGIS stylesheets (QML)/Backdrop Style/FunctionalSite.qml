...
<qgis minScale="1e+08" simplifyDrawingHints="0" maxScale="-4.65661e-10" simplifyMaxScale="1" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" version="3.4.1-Madeira" styleCategories="AllStyleCategories" simplifyAlgorithm="0" labelsEnabled="1" simplifyDrawingTol="1">
  <flags>
    <Identifiable>1</Identifiable>
    <Removable>1</Removable>
    <Searchable>1</Searchable>
  </flags>
  <renderer-v2 enableorderby="0" type="categorizedSymbol" attr="featureCode" forceraster="0" symbollevels="0">
    <categories>
      <category symbol="0" label="Education Facility - School" render="true" value="25250"/>
      <category symbol="1" label="Police Station" render="true" value="25251"/>
      <category symbol="2" label="Medical Care" render="true" value="25252"/>
      <category symbol="3" label="Place Of Worship" render="true" value="25253"/>
      <category symbol="4" label="Leisure Or Sports Centre" render="true" value="25254"/>
      <category symbol="5" label="Air Transport" render="true" value="25255"/>
      <category symbol="6" label="Education Facility - Higher" render="true" value="25256"/>
      <category symbol="7" label="Water Transport" render="true" value="25257"/>
      <category symbol="8" label="Road Transport" render="true" value="25258"/>
      <category symbol="9" label="Road Services" render="true" value="25259"/>
    </categories>
    <symbols>
      <symbol alpha="1" type="marker" clip_to_extent="1" name="0">
        <layer enabled="1" pass="0" class="SimpleMarker" locked="0">
          ...
          <prop v="-2.60000000000000009,-15.80000000000000071" k="offset"/>
        ...
        <layer enabled="1" pass="0" class="SimpleMarker" locked="0">
          ...
          <prop v="bevel" k="joinstyle"/>
          <prop v="triangle" k="name"/>
          <prop v="3.70000000000000018,-20.39999999999999858" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MapUnit" k="offset_unit"/>
          <prop v="0,0,0,0" k="outline_color"/>
      ...
      <symbol alpha="1" type="marker" clip_to_extent="1" name="2">
        <layer enabled="1" pass="0" class="FontMarker" locked="0">
          ...
          <prop v="1" k="horizontal_anchor_point"/>
          <prop v="miter" k="joinstyle"/>
          <prop v="0,-15.40000000000000036" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MapUnit" k="offset_unit"/>
          <prop v="255,255,255,255" k="outline_color"/>
          <prop v="0" k="outline_width"/>
      ...
      <symbol alpha="1" type="marker" clip_to_extent="1" name="9">
        <layer enabled="1" pass="0" class="FontMarker" locked="0">
          ...
          <prop v="1" k="horizontal_anchor_point"/>
          <prop v="miter" k="joinstyle"/>
          <prop v="0,-19.39999999999999858" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MapUnit" k="offset_unit"/>
          <prop v="255,255,255,255" k="outline_color"/>
          <prop v="0" k="outline_width"/>
  ...
  <labeling type="simple">
    <settings>
      <text-style useSubstitutions="0" fontLetterSpacing="0" textColor="113,113,113,255" multilineHeight="1" fontWordSpacing="0" fontWeight="50" isExpression="1" fontItalic="0" blendMode="0" textOpacity="1" fontFamily="Arial" namedStyle="Regular" fontUnderline="0" fontSizeUnit="MapUnit" fontCapitals="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" previewBkgrdColor="#ffffff" fontSize="40" fieldName="wordwrap(&quot;distinctiveName&quot;, 20)" fontStrikeout="0">
        <text-buffer bufferBlendMode="0" bufferSize="0.75" bufferDraw="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferOpacity="0.8" bufferNoFill="0" bufferJoinStyle="128" bufferSizeUnits="MM" bufferColor="255,255,255,255"/>
      ...
      <placement predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" priority="3" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" rotationAngle="0" quadOffset="4" maxCurvedCharAngleIn="20" maxCurvedCharAngleOut="-20" xOffset="0" distMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" placement="0" repeatDistanceUnits="MM" offsetUnits="MapUnit" yOffset="0" centroidInside="0" preserveRotation="1" dist="30" fitInPolygonOnly="0" placementFlags="0" distUnits="MapUnit" repeatDistance="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetType="0"/>
      <rendering upsidedownLabels="0" drawLabels="1" labelPerPart="0" minFeatureSize="0" fontLimitPixelSize="0" zIndex="0" mergeLines="0" scaleVisibility="0" scaleMax="10000000" obstacleFactor="1" fontMaxPixelSize="10000" displayAll="0" fontMinPixelSize="3" obstacle="1" scaleMin="1" limitNumLabels="1" obstacleType="0" maxNumLabels="600"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" value="" name="name"/>
          <Option type="Map" name="properties">
            <Option type="Map" name="Color">
              ...
              <Option type="QString" value="CASE WHEN (&quot;CLASSIFICA&quot; LIKE '%Transport') OR (&quot;CLASSIFICA&quot; LIKE 'Road%') THEN color_rgb(115,113,113) ELSE color_rgb(113,113,113) END" name="expression"/>
              <Option type="int" value="3" name="type"/>
            </Option>
            <Option type="Map" name="Size">
              <Option type="bool" value="true" name="active"/>
              <Option type="QString" value="CASE WHEN  &quot;FEATCODE&quot;  =  25255 THEN 62 ELSE 40 END" name="expression"/>
              <Option type="int" value="3" name="type"/>
            </Option>
          </Option>
          <Option type="QString" value="collection" name="type"/>
  ...
  <aliases>
    ...
    <alias field="featureCode" index="4" name=""/>
  </aliases>
