...
<qgis minScale="1e+08" simplifyDrawingHints="0" maxScale="-4.65661e-10" simplifyMaxScale="1" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" version="3.4.1-Madeira" styleCategories="AllStyleCategories" simplifyAlgorithm="0" labelsEnabled="1" simplifyDrawingTol="1">
  ...
  <labeling type="simple">
    <settings>
      <text-style useSubstitutions="0" fontLetterSpacing="0" textColor="0,0,0,255" multilineHeight="1" fontWordSpacing="0" fontWeight="50" isExpression="1" fontItalic="0" blendMode="0" textOpacity="1" fontFamily="Arial" namedStyle="Regular" fontUnderline="0" fontSizeUnit="MapUnit" fontCapitals="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" previewBkgrdColor="#ffffff" fontSize="44.1" fieldName="CASE WHEN length( &quot;distinctiveName&quot; ) > 13 AND strpos(&quot;distinctiveName&quot;,' ') > 6 THEN replace(&quot;distinctiveName&quot;,' ','  ') WHEN length( &quot;distinctiveName&quot; ) > 20 AND &quot;distinctiveName&quot; LIKE '%Golf Course' THEN regexp_replace(&quot;distinctiveName&quot;,'Golf Course',' Golf Course') WHEN length( &quot;distinctiveName&quot; ) > 20 AND &quot;distinctiveName&quot; LIKE '%Nature Reserve' THEN regexp_replace(&quot;distinctiveName&quot;,'Nature Reserve',' Nature Reserve') WHEN length( &quot;distinctiveName&quot; ) > 20 AND &quot;distinctiveName&quot; LIKE '%Church Of England%' THEN regexp_replace(&quot;distinctiveName&quot;,'Church Of England',' Church Of England ') WHEN length( &quot;distinctiveName&quot; ) > 13 AND &quot;distinctiveName&quot; LIKE '% Of The %' THEN regexp_replace(&quot;distinctiveName&quot;,'Of The','Of The ') WHEN length( &quot;distinctiveName&quot; ) > 13 AND &quot;distinctiveName&quot; LIKE '% of %' AND &quot;classification&quot; &lt;> 'Hydrography' THEN regexp_replace(&quot;distinctiveName&quot;,' of ',' of ') WHEN &quot;distinctiveName&quot; LIKE '%/%' THEN regexp_replace(&quot;distinctiveName&quot;,'/','/ ') WHEN length( &quot;distinctiveName&quot; ) > 30 THEN replace(&quot;distinctiveName&quot;,' ','  ') ELSE &quot;DISTNAME&quot; END" fontStrikeout="0">
        <text-buffer bufferBlendMode="0" bufferSize="1" bufferDraw="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferOpacity="0.85" bufferNoFill="0" bufferJoinStyle="128" bufferSizeUnits="MM" bufferColor="252,252,250,255"/>
