...
<qgis minScale="1e+08" simplifyDrawingHints="0" maxScale="-4.65661e-10" simplifyMaxScale="1" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" version="3.4.1-Madeira" styleCategories="AllStyleCategories" simplifyAlgorithm="0" labelsEnabled="1" simplifyDrawingTol="1">
  ...
  <labeling type="simple">
    <settings>
      <text-style useSubstitutions="0" fontLetterSpacing="0" textColor="157,113,51,255" multilineHeight="1" fontWordSpacing="0" fontWeight="75" isExpression="0" fontItalic="0" blendMode="0" textOpacity="1" fontFamily="Arial" namedStyle="Bold" fontUnderline="0" fontSizeUnit="MapUnit" fontCapitals="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" previewBkgrdColor="#ffffff" fontSize="47" fieldName="height" fontStrikeout="0">
        <text-buffer bufferBlendMode="0" bufferSize="0.6" bufferDraw="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferOpacity="0.75" bufferNoFill="0" bufferJoinStyle="128" bufferSizeUnits="MM" bufferColor="252,252,250,255"/>
      ...
      <placement predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" priority="6" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" rotationAngle="0" quadOffset="4" maxCurvedCharAngleIn="20" maxCurvedCharAngleOut="-20" xOffset="0" distMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" placement="0" repeatDistanceUnits="MM" offsetUnits="MapUnit" yOffset="0" centroidInside="0" preserveRotation="1" dist="30" fitInPolygonOnly="0" placementFlags="0" distUnits="MapUnit" repeatDistance="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetType="0"/>
  ...
  <aliases>
    ...
    <alias field="height_uom" index="3" name=""/>
  ...
  <defaults>
    ...
    <default field="height_uom" applyOnUpdate="0" expression=""/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" field="height_uom" notnull_strength="0" constraints="0" unique_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="height_uom" desc=""/>
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column type="field" hidden="0" width="-1" name="height"/>
      <column type="field" hidden="0" width="-1" name="height_uom"/>
