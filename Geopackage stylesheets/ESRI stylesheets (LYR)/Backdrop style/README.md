...
**8.**  Your Table of Contents should now look like this. This is the recommended layer order: 
  ...
  ![Screenshot](https://github.com/OrdnanceSurvey/OS-VectorMap-District-stylesheets/raw/master/ESRI%20Shapefile%20stylesheets/ESRI%20stylesheets%20(LYR)/Backdrop%20style/images/VMD_BD_layer_order.PNG "Recommended layer order for OS VectorMap District")
