...
xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.0.0/StyledLayerDescriptor.xsd">
  <NamedLayer>
    <Name>OS VectorMap&#174; District (Full Colour style) - Airport</Name>
    <UserStyle>
      ...
      <FeatureTypeStyle>
        <Rule>
          ...
          <PointSymbolizer>
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:href="ordnance_survey/Airport-fc.svg"/>
          ...
          <TextSymbolizer>
            ...
            <Fill>
              <CssParameter name="fill">#080707</CssParameter>
            </Fill>
