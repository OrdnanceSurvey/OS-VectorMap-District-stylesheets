...
<qgis styleCategories="AllStyleCategories" minScale="25001" labelsEnabled="1" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" version="3.16.7-Hannover" simplifyMaxScale="1" readOnly="0" hasScaleBasedVisibilityFlag="1" maxScale="10000" simplifyDrawingHints="0">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontUnderline="0" fontItalic="0" useSubstitutions="0" fieldName="CASE WHEN length( &quot;DISTNAME&quot; ) > 13 AND strpos(&quot;DISTNAME&quot;,' ') > 6 THEN replace(&quot;DISTNAME&quot;,' ','  ') WHEN length( &quot;DISTNAME&quot; ) > 20 AND &quot;DISTNAME&quot; LIKE '%Golf Course' THEN regexp_replace(&quot;DISTNAME&quot;,'Golf Course',' Golf Course') WHEN length( &quot;DISTNAME&quot; ) > 20 AND &quot;DISTNAME&quot; LIKE '%Nature Reserve' THEN regexp_replace(&quot;DISTNAME&quot;,'Nature Reserve',' Nature Reserve') WHEN length( &quot;DISTNAME&quot; ) > 20 AND &quot;DISTNAME&quot; LIKE '%Church Of England%' THEN regexp_replace(&quot;DISTNAME&quot;,'Church Of England',' Church Of England ') WHEN length( &quot;DISTNAME&quot; ) > 13 AND &quot;DISTNAME&quot; LIKE '% Of The %' THEN regexp_replace(&quot;DISTNAME&quot;,'Of The','Of The ') WHEN length( &quot;DISTNAME&quot; ) > 13 AND &quot;DISTNAME&quot; LIKE '% of %' AND &quot;CLASSIFICA&quot; &lt;> 'Hydrography' THEN regexp_replace(&quot;DISTNAME&quot;,' of ',' of ') WHEN &quot;DISTNAME&quot; LIKE '%/%' THEN regexp_replace(&quot;DISTNAME&quot;,'/','/ ') WHEN length( &quot;DISTNAME&quot; ) > 30 THEN replace(&quot;DISTNAME&quot;,' ','  ') ELSE &quot;DISTNAME&quot; END" namedStyle="Regular" fontWeight="50" fontLetterSpacing="0" fontFamily="Arial" fontKerning="1" capitalization="0" fontSizeUnit="MapUnit" allowHtml="0" textOpacity="1" textColor="113,113,113,255" fontSize="44.1" isExpression="1" previewBkgrdColor="255,255,255,255" fontStrikeout="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" multilineHeight="1" textOrientation="horizontal" fontWordSpacing="0">
        <text-buffer bufferOpacity="0.85" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="250,249,247,255" bufferNoFill="0" bufferJoinStyle="128" bufferBlendMode="0" bufferDraw="1" bufferSizeUnits="MM" bufferSize="1"/>
        ...
        <Option type="Map">
          ...
          <Option name="properties" type="Map">
            <Option name="Color" type="Map">
              ...
              <Option name="expression" type="QString" value="CASE WHEN &quot;CLASSIFICA&quot; = 'Woodland Or Forest' THEN color_rgb(121,165,114) WHEN &quot;CLASSIFICA&quot; = 'Hydrography' THEN color_rgb(37,173,201) ELSE color_rgb(113,113,113) END"/>
