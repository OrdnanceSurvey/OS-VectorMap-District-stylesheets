...
<qgis version="2.8.1-Wien" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="HTMLNAME">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="CASE WHEN length( &quot;DISTNAME&quot; ) > 13 AND strpos(&quot;DISTNAME&quot;,' ') > 6 THEN replace(&quot;DISTNAME&quot;,' ','  ') WHEN length( &quot;DISTNAME&quot; ) > 20 AND &quot;DISTNAME&quot; LIKE '%Golf Course' THEN regexp_replace(&quot;DISTNAME&quot;,'Golf Course',' Golf Course') WHEN length( &quot;DISTNAME&quot; ) > 20 AND &quot;DISTNAME&quot; LIKE '%Nature Reserve' THEN regexp_replace(&quot;DISTNAME&quot;,'Nature Reserve',' Nature Reserve') WHEN length( &quot;DISTNAME&quot; ) > 20 AND &quot;DISTNAME&quot; LIKE '%Church Of England%' THEN regexp_replace(&quot;DISTNAME&quot;,'Church Of England',' Church Of England ') WHEN length( &quot;DISTNAME&quot; ) > 13 AND &quot;DISTNAME&quot; LIKE '% Of The %' THEN regexp_replace(&quot;DISTNAME&quot;,'Of The','Of The ') WHEN length( &quot;DISTNAME&quot; ) > 13 AND &quot;DISTNAME&quot; LIKE '% of %' AND &quot;CLASSIFICA&quot; &lt;> 'Hydrography' THEN regexp_replace(&quot;DISTNAME&quot;,' of ',' of ') WHEN &quot;DISTNAME&quot; LIKE '%/%' THEN regexp_replace(&quot;DISTNAME&quot;,'/','/ ') WHEN length( &quot;DISTNAME&quot; ) > 30 THEN replace(&quot;DISTNAME&quot;,' ','  ') ELSE &quot;DISTNAME&quot; END"/>
