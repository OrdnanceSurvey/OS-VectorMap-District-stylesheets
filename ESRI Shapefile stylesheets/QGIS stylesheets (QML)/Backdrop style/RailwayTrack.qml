...
<qgis styleCategories="AllStyleCategories" minScale="25001" labelsEnabled="0" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" version="3.16.7-Hannover" simplifyMaxScale="1" readOnly="0" hasScaleBasedVisibilityFlag="1" maxScale="10000" simplifyDrawingHints="1">
  ...
  <renderer-v2 attr="FEATCODE" enableorderby="0" type="categorizedSymbol" symbollevels="0" forceraster="0">
    <categories>
      <category render="true" symbol="0" label="Multi Track" value="25300"/>
      <category render="true" symbol="1" label="Single Track" value="25301"/>
      <category render="true" symbol="2" label="Narrow Gauge" value="25302"/>
    </categories>
    <symbols>
