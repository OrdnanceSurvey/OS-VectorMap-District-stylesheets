...
<qgis styleCategories="AllStyleCategories" minScale="25001" labelsEnabled="1" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" version="3.16.7-Hannover" simplifyMaxScale="1" readOnly="0" hasScaleBasedVisibilityFlag="1" maxScale="10000" simplifyDrawingHints="0">
  ...
  <renderer-v2 attr="FEATCODE" enableorderby="0" type="categorizedSymbol" symbollevels="0" forceraster="0">
    <categories>
      <category render="false" symbol="0" label="Education Facility - School" value="25250"/>
      <category render="false" symbol="1" label="Police Station" value="25251"/>
      <category render="false" symbol="2" label="Medical Care" value="25252"/>
      <category render="false" symbol="3" label="Place Of Worship" value="25253"/>
      <category render="false" symbol="4" label="Leisure Or Sports Centre" value="25254"/>
      <category render="true" symbol="5" label="Air Transport" value="25255"/>
      <category render="false" symbol="6" label="Education Facility - Higher" value="25256"/>
      <category render="false" symbol="7" label="Water Transport" value="25257"/>
      <category render="false" symbol="8" label="Road Transport" value="25258"/>
      <category render="true" symbol="9" label="Road Services" value="25259"/>
    </categories>
    <symbols>
      <symbol clip_to_extent="1" name="0" force_rhr="0" type="marker" alpha="1">
        <layer pass="0" class="SvgMarker" locked="0" enabled="1">
          ...
          <prop k="name" v="ordnance_survey/Education-bd.svg"/>
          <prop k="offset" v="0,0"/>
      ...
      <symbol clip_to_extent="1" name="1" force_rhr="0" type="marker" alpha="1">
        ...
        <layer pass="0" class="SvgMarker" locked="0" enabled="1">
          ...
          <prop k="fixedAspectRatio" v="0"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="ordnance_survey/Police-bd.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          <prop k="outline_color" v="255,255,255,255"/>
      ...
      <symbol clip_to_extent="1" name="2" force_rhr="0" type="marker" alpha="1">
        <layer pass="0" class="SimpleMarker" locked="0" enabled="1">
          ...
          <prop k="outline_color" v="112,114,217,255"/>
      ...
      <symbol clip_to_extent="1" name="4" force_rhr="0" type="marker" alpha="1">
        <layer pass="0" class="SvgMarker" locked="0" enabled="1">
          ...
          <prop k="fixedAspectRatio" v="0"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="ordnance_survey/Leisure-bd.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          <prop k="outline_color" v="255,255,255,255"/>
      ...
      <symbol clip_to_extent="1" name="5" force_rhr="0" type="marker" alpha="1">
        <layer pass="0" class="SvgMarker" locked="0" enabled="1">
          ...
          <prop k="fixedAspectRatio" v="0"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="ordnance_survey/AirTrans-bd.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          <prop k="outline_color" v="255,255,255,255"/>
      ...
      <symbol clip_to_extent="1" name="7" force_rhr="0" type="marker" alpha="1">
        <layer pass="0" class="SvgMarker" locked="0" enabled="1">
          ...
          <prop k="fixedAspectRatio" v="0"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="ordnance_survey/WaterTrans-bd.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          <prop k="outline_color" v="255,255,255,255"/>
      ...
      <symbol clip_to_extent="1" name="8" force_rhr="0" type="marker" alpha="1">
        <layer pass="0" class="SvgMarker" locked="0" enabled="1">
          ...
          <prop k="fixedAspectRatio" v="0"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="ordnance_survey/RoadTrans-bd.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          <prop k="outline_color" v="255,255,255,255"/>
      ...
      <symbol clip_to_extent="1" name="9" force_rhr="0" type="marker" alpha="1">
        <layer pass="0" class="SvgMarker" locked="0" enabled="1">
          ...
          <prop k="fixedAspectRatio" v="0"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="ordnance_survey/Services-bd.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          <prop k="outline_color" v="255,255,255,255"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontUnderline="0" fontItalic="0" useSubstitutions="0" fieldName="wordwrap(&quot;DISTNAME&quot;, 20)" namedStyle="Regular" fontWeight="50" fontLetterSpacing="0" fontFamily="Arial" fontKerning="1" capitalization="0" fontSizeUnit="MapUnit" allowHtml="0" textOpacity="1" textColor="113,113,113,255" fontSize="40" isExpression="1" previewBkgrdColor="255,255,255,255" fontStrikeout="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" multilineHeight="1" textOrientation="horizontal" fontWordSpacing="0">
        <text-buffer bufferOpacity="0.8" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="255,255,255,255" bufferNoFill="0" bufferJoinStyle="128" bufferBlendMode="0" bufferDraw="1" bufferSizeUnits="MM" bufferSize="0.75"/>
      ...
      <placement predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" offsetUnits="MapUnit" repeatDistance="0" lineAnchorType="0" placementFlags="0" quadOffset="4" geometryGenerator="" layerType="PointGeometry" lineAnchorPercent="0.5" dist="30" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" placement="0" centroidWhole="0" repeatDistanceUnits="MM" polygonPlacementFlags="2" geometryGeneratorEnabled="0" distUnits="MapUnit" centroidInside="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorType="PointGeometry" distMapUnitScale="3x:0,0,0,0,0,0" priority="3" overrunDistance="0" overrunDistanceUnit="MM" maxCurvedCharAngleIn="20" offsetType="0" rotationAngle="0" xOffset="0" preserveRotation="1" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" yOffset="0" maxCurvedCharAngleOut="-20"/>
      <rendering scaleMin="1" zIndex="0" drawLabels="1" minFeatureSize="0" mergeLines="0" displayAll="0" upsidedownLabels="0" obstacleFactor="1" scaleMax="10000000" fontLimitPixelSize="0" limitNumLabels="1" maxNumLabels="600" labelPerPart="0" fontMaxPixelSize="10000" scaleVisibility="0" obstacleType="0" obstacle="1" fontMinPixelSize="3"/>
      <dd_properties>
        <Option type="Map">
          <Option name="name" type="QString" value=""/>
          <Option name="properties" type="Map">
            <Option name="Color" type="Map">
              ...
              <Option name="expression" type="QString" value="CASE WHEN (&quot;CLASSIFICA&quot; LIKE '%Transport') OR (&quot;CLASSIFICA&quot; LIKE 'Road%') THEN color_rgb(115,113,113) ELSE color_rgb(113,113,113) END"/>
              <Option name="type" type="int" value="3"/>
            </Option>
            <Option name="Size" type="Map">
              <Option name="active" type="bool" value="true"/>
              <Option name="expression" type="QString" value="CASE WHEN  &quot;FEATCODE&quot;  =  25255 THEN 62 ELSE 40 END"/>
              <Option name="type" type="int" value="3"/>
            </Option>
          </Option>
          <Option name="type" type="QString" value="collection"/>
  ...
  <aliases>
    ...
    <alias field="CLASSIFICA" index="2" name=""/>
    <alias field="FEATCODE" index="3" name=""/>
  </aliases>
  <defaults>
