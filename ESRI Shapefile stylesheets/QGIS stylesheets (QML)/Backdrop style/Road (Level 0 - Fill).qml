...
<qgis version="2.8.1-Wien" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="FEATCODE" symbollevels="1" type="categorizedSymbol">
    <categories>
  ...
  <customproperties>
    ...
    <property key="labeling/dataDefined/ShapeFillColor" value="1~~1~~CASE WHEN  &quot;CLASSIFICA&quot; LIKE 'A%' THEN  color_rgb(235,148,177) WHEN  &quot;CLASSIFICA&quot; LIKE 'B%' THEN  color_rgb(237,186,145) WHEN  &quot;CLASSIFICA&quot; LIKE 'P%' THEN  color_rgb(136,191,143) WHEN  &quot;CLASSIFICA&quot; LIKE 'M%' THEN  color_rgb(54,177,201) END~~"/>
    <property key="labeling/dataDefined/ShapeOffset" value="1~~1~~CASE WHEN &quot;FEATCODE&quot; = 25729 OR &quot;FEATCODE&quot; = 25739 THEN '3,0' ELSE '0,0' END~~"/>
    <property key="labeling/dataDefined/ShapeSizeX" value="1~~1~~CASE WHEN &quot;FEATCODE&quot; = 25729 OR &quot;FEATCODE&quot; = 25739 THEN 11 ELSE 15 END~~"/>
    ...
    <property key="labeling/fieldName" value="CASE WHEN  &quot;FEATCODE&quot; = 25729 OR &quot;FEATCODE&quot; = 25739 THEN  regexp_replace( &quot;ROADNUMBER&quot;, 'A',' A') ELSE  &quot;ROADNUMBER&quot; END"/>
