...
<qgis styleCategories="AllStyleCategories" minScale="25001" labelsEnabled="0" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" version="3.16.7-Hannover" simplifyMaxScale="1" readOnly="0" hasScaleBasedVisibilityFlag="1" maxScale="10000" simplifyDrawingHints="1">
  ...
  <renderer-v2 enableorderby="0" type="RuleRenderer" symbollevels="0" forceraster="0">
    <rules key="{6940fe15-e206-4af3-8c2a-4ea21bfd51b1}">
      <rule scalemaxdenom="17500" symbol="0" label="1:10,000 to 1:17,500" scalemindenom="9999" key="{fd5ba4c6-18b0-4688-b01e-39a008c3dfe4}"/>
      <rule scalemaxdenom="25001" symbol="1" label="1:17,500 to 1:25,000" scalemindenom="17500" key="{987814b1-1adf-40a2-9148-b9be0b168e7c}"/>
    </rules>
    <symbols>
