...
<qgis styleCategories="AllStyleCategories" minScale="25001" labelsEnabled="1" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" version="3.16.7-Hannover" simplifyMaxScale="1" readOnly="0" hasScaleBasedVisibilityFlag="1" maxScale="10000" simplifyDrawingHints="0">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontUnderline="0" fontItalic="0" useSubstitutions="0" fieldName="JUNCTNUM" namedStyle="Bold" fontWeight="75" fontLetterSpacing="0" fontFamily="Arial" fontKerning="1" capitalization="0" fontSizeUnit="MapUnit" allowHtml="0" textOpacity="1" textColor="255,255,255,255" fontSize="50" isExpression="0" previewBkgrdColor="255,255,255,255" fontStrikeout="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" multilineHeight="1" textOrientation="horizontal" fontWordSpacing="0">
        ...
        <background shapeBorderColor="54,177,201,199" shapeOpacity="1" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeDraw="1" shapeRotation="0" shapeBlendMode="0" shapeRadiiUnit="MM" shapeType="0" shapeSizeUnit="MapUnit" shapeFillColor="54,177,201,255" shapeOffsetUnit="MM" shapeJoinStyle="64" shapeRotationType="0" shapeSizeY="3" shapeBorderWidth="0.2646" shapeSVGFile="" shapeOffsetY="0" shapeBorderWidthUnit="MM" shapeSizeX="15" shapeSizeType="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiY="0" shapeRadiiX="0" shapeOffsetX="0">
      ...
      <placement predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" offsetUnits="MapUnit" repeatDistance="0" lineAnchorType="0" placementFlags="0" quadOffset="4" geometryGenerator="" layerType="PointGeometry" lineAnchorPercent="0.5" dist="180" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" placement="0" centroidWhole="0" repeatDistanceUnits="MM" polygonPlacementFlags="2" geometryGeneratorEnabled="0" distUnits="MapUnit" centroidInside="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorType="PointGeometry" distMapUnitScale="3x:0,0,0,0,0,0" priority="10" overrunDistance="0" overrunDistanceUnit="MM" maxCurvedCharAngleIn="20" offsetType="0" rotationAngle="0" xOffset="0" preserveRotation="1" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" yOffset="0" maxCurvedCharAngleOut="-20"/>
  ...
  <fieldConfiguration>
    ...
    <field name="JUNCTNUM" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias field="JUNCTNUM" index="1" name=""/>
    <alias field="FEATCODE" index="2" name=""/>
  </aliases>
  <defaults>
    <default field="ID" expression="" applyOnUpdate="0"/>
    <default field="JUNCTNUM" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="JUNCTNUM" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="FEATCODE" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
  </constraints>
  <constraintExpressions>
    <constraint field="ID" desc="" exp=""/>
    <constraint field="JUNCTNUM" desc="" exp=""/>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column name="JUNCTNUM" type="field" hidden="0" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="JUNCTNUM"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="JUNCTNUM"/>
