...
<qgis version="2.0.1-Dufour" minimumScale="-4.65661e-10" maximumScale="1e+08" minLabelScale="1" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 attr="CLASSIFICA" symbollevels="0" type="categorizedSymbol">
    <categories>
      ...
      <category symbol="1" value="Hospital" label="Hospital"/>
      <category symbol="2" value="Leisure Or Sports Centre" label="Leisure Or Sports Centre"/>
      <category symbol="3" value="Place Of Worship" label="Place Of Worship"/>
      <category symbol="4" value="Police Station" label="Police Station"/>
    </categories>
    <symbols>
      ...
      <symbol alpha="1" type="marker" name="3">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="73,81,199,255"/>
          <prop k="color_border" v="73,81,199,255"/>
          <prop k="name" v="cross"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
