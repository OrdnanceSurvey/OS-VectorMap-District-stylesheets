...
<qgis hasScaleBasedVisibilityFlag="1" minScale="25001" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyLocal="1" version="3.16.7-Hannover" readOnly="0" styleCategories="AllStyleCategories" maxScale="10000" simplifyMaxScale="1" simplifyAlgorithm="0" labelsEnabled="1">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style previewBkgrdColor="255,255,255,255" blendMode="0" textColor="164,143,122,255" fontWordSpacing="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontFamily="Arial" fontKerning="1" capitalization="0" fontSizeUnit="MapUnit" fontItalic="0" fontUnderline="0" fontWeight="75" fontSize="47" isExpression="0" namedStyle="Bold" textOrientation="horizontal" textOpacity="1" fontStrikeout="0" useSubstitutions="0" multilineHeight="1" allowHtml="0" fieldName="height" fontLetterSpacing="0">
        <text-buffer bufferBlendMode="0" bufferOpacity="0.75" bufferJoinStyle="128" bufferSizeUnits="MM" bufferSize="0.6" bufferNoFill="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="252,252,250,255" bufferDraw="1"/>
      ...
      <placement priority="7" geometryGeneratorEnabled="0" centroidWhole="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" quadOffset="4" lineAnchorPercent="0.5" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" offsetType="0" polygonPlacementFlags="2" offsetUnits="MapUnit" placement="0" maxCurvedCharAngleOut="-20" repeatDistance="0" layerType="PointGeometry" xOffset="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" distUnits="MapUnit" distMapUnitScale="3x:0,0,0,0,0,0" placementFlags="0" fitInPolygonOnly="0" overrunDistance="0" overrunDistanceUnit="MM" geometryGenerator="" geometryGeneratorType="PointGeometry" yOffset="0" lineAnchorType="0" rotationAngle="0" preserveRotation="1" maxCurvedCharAngleIn="20" repeatDistanceUnits="MM" dist="30"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="height_uom">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias field="height_uom" name="" index="3"/>
  ...
  <defaults>
    ...
    <default field="height_uom" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" field="height" constraints="1" unique_strength="0" notnull_strength="1"/>
    <constraint exp_strength="0" field="height_uom" constraints="1" unique_strength="0" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="height_uom" desc="" exp=""/>
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column hidden="0" type="field" name="height_uom" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="height_uom"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="height_uom"/>
